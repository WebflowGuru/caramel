...
const models = {
    Audi: ["Model", "A3 e-tron", "A3 e-tron ultra", "A7 TFSI e Quattro", "A8 L 60 TFSI e Quattro", "A8L PHEV", "e-tron", "e-tron Sportback", "Q5 PHEV", "Q5 TFSI e Quattro"],
    Bentley: ["Model", "Bentayga Hybrid SUV"],
    BMW: ["Model", "330e", "330e xDrive", "530e", "530e xDrive", "740e", "740e xDrive", "745e xDrive", "i3 (60 Ah) Sedan", "i3 Sedan", "i3 Sedan with Range Extender", "i3s Sedan", "i3s Sedan with Range Extender", "i4 Gran Coupe", "i8", "i8 Coupe", "i8 Roadster", "X3 xDrive30e", "X5 xDrive40e", "X5 xDrive45e"],
    Cadillac: ["Model", "ELR"],
    Chevrolet: ["Model", "Bolt", "Bolt EV", "Bolt EV EUV", "Spark EV", "Volt"],
    Chrysler: ["Model", "Pacifica PHEV"],
    Fiat: ["Model", "500e"],
    Ford: ["Model", "Escape Plug-in Hybrid", "Focus Electric", "Fusion Energi", "Mustang Mach-E"],
    Honda: ["Model", "Clarity Plug-in Hybrid"],
    Hyundai: ["Model", "Ioniq Electric Battery Vehicle", "Ioniq Plug-In Hybrid Electric Vehicle", "Kona Electric Vehicle", "Nexo Blue Fuel Cell Vehicle", "Nexo Fuel Cell Vehicle", "Sonata Plug-In Hybrid Vehicle"],
    Jeep: ["Model", "Wrangler 4xe"],
    Kia: ["Model", "Niro EV", "Niro PHEV", "Optima PHEV", "Soul EV"],
    Lexus: ["Model", "NX Plug-In Hybrid"],
    Lincoln: ["Model", "Aviator Grand Touring", "Corsair Grand Touring"],
    Lucid: ["Model", "Air (All Models)"],
    Mercedes_Benz: ["Model", "B-Class EV (B250e)", "EQB SUV (All Models)", "EQS Sedan (All Models)", "GLC350e 4matic", "GLC350e 4matic EQ", "GLE550e 4matic PHEV", "S550e PHEV", "S560e EQ PHEV"],
    MINI: ["Model", "Cooper S E Countryman ALL4", "Cooper S E Hardtop"],
    Mitsubishi: ["Model", "i-MiEV", "Outlander PHEV"],
    Nissan: ["Model", "Leaf (All Models)"],
    Polestar_Automotive: ["Model", "Polestar 1", "Polestar 2"],
    Porsche: ["Model", "Cayenne E-Hybrid (All models)", "Cayenne E-Hybrid (All Models)", "Panamera E-Hybrid (All models)", "Panamera E-Hybrid (All Models)", "Taycan (All EV Models)", "Taycan (All Models)"],
    Rivian: ["Model", "EDV 700", "Rivian", "Rivian"],
    smart_USA: ["Model", "Cabrio EV", "Coupe EV", "EQ Fortwo Cabrio", "EQ Fortwo Coupe"],
    Subaru: ["Model", "Crosstrek Hybrid", "Crosstrek Plug-In Hybrid"],
    Tesla: ["Model", "Model 3", "Model S", "Model X", "Model Y", "Roadster"],
    Toyota: ["Model", "Mirai", "Prius Prime Plug-In Hybrid", "RAV4 EV", "RAV4 Prime Plug-In Hybrid"],
    Volkswagen: ["Model", "e-Golf", "ID.4 (All Models)"],
    Volvo: ["Model", "C40 Recharge", "S60", "S90", "V60", "XC40 Recharge", "XC60", "XC90"],
  Other: ["Model"],
  Other: ["Other"],
}; // Example models
...
function checkQualificationInExcel(year, make, model) {
	...
	{ year: 2021, make: "Polestar_Automotive", model: "Model" },
...
{ year: 2020, make: "MINI", model: "Model" },
	...
	{ year: 2020, make: "Polestar_Automotive", model: "Model" },
